...
def parse_args():
    ...
    parser.add_argument('--noise',choices=['Gaussian', 'Poisson'], default='Gaussian', help='Type of noise to use for training')
...
if __name__ == '__main__':
    args = parse_args()
    train_loader = BerkeleyLoader(sigma=args.sigma, train=True, noise = args.noise, batch_size=1, shuffle=True, num_workers=1)
    test_loader = BerkeleyLoader(sigma=args.sigma, train=False, noise=args.noise, num_workers=1)
